...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header${add_attribute(
    ...
    0
  )}><h1 class="font-medium" data-svelte-h="svelte-1x5gpa7"><b class="font-bold poppins">Ndifreke</b> <span class="">Okorie</span></h1> <div class="sm:flex items-center gap-4 hidden">${each(tabs, (tab, index) => {
